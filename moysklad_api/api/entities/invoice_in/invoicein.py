...
class GetInvoicesInRequest(types.ApiRequest):
    ...
    def to_request(self) -> dict:
        ...
        return {
            "method": "GET",
            "url": "https://online.moysklad.ru/api/remap/1.2/entity/invoicein",
            "params": params,
        }
...
class UpdateInvoiceInRequest(types.ApiRequest):
    ...
    def to_request(self) -> dict:
        ...
        return {
            "method": "PUT",
            "url": f"https://online.moysklad.ru/api/remap/1.2/entity/invoicein/{self.invoice_in_id}",
            "json": json_data,
        }
...
class GetInvoiceInPositionRequest(types.ApiRequest):
    ...
    def to_request(self) -> dict:
        return {
            "method": "GET",
            "url": f"https://online.moysklad.ru/api/remap/1.2/entity/invoicein/"
