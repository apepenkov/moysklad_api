...
class DeleteStoreRequest(types.ApiRequest):
    ...
    def to_request(self) -> dict:
        return {
            "method": "DELETE",
            "url": f"https://online.moysklad.ru/api/remap/1.2/entity/store/{self.id}",
            "allow_non_json": True,
        }
...
class GetStoreSlotsRequest(types.ApiRequest):
    ...
    def to_request(self) -> dict:
        ...
        return {
            "method": "GET",
            "url": f"https://online.moysklad.ru/api/remap/1.2/entity/store/{self.store_id}/slots",
            "params": params,
        }
...
class UpdateStoreSlotRequest(types.ApiRequest):
    ...
    def to_request(self) -> dict:
        ...
        return {
            "method": "PUT",
            "url": f"https://online.moysklad.ru/api/remap/1.2/entity/store/{self.store_id}/slots/{self.slot_id}",
            "json": json_data,
        }
