...
class Prepayment(types.MoySkladBaseClass):
    """Предоплата (entity/prepayment)."""
    ...
    returns: typing.Optional[typing.List[dict]]
    ...
    @classmethod
    def from_json(cls, dict_data: dict) -> "Prepayment":
        instance = cls()
        ...
        instance.returns = dict_data.get("returns")
...
class GetPrepaymentsRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET", url=f"{helpers.BASE_URL}/entity/prepayment", params=params
        )

    def from_response(self, result: dict) -> typing.List[Prepayment]:
        return [Prepayment.from_json(x) for x in result["rows"]]


class CreatePrepaymentRequest(types.ApiRequest):
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="POST", url=f"{helpers.BASE_URL}/entity/prepayment", json=json_data
        )

    def from_response(self, result: dict) -> Prepayment:
        return Prepayment.from_json(result)


class DeletePrepaymentRequest(types.ApiRequest):
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="DELETE",
            url=f"{helpers.BASE_URL}/entity/prepayment/{self.id}",
            allow_non_json=True,
        )
...
class GetPrepaymentRequest(types.ApiRequest):
    def __init__(self, id_: str):
        self.id = id_

    def to_request(self) -> RequestData:
        return RequestData(
            method="GET", url=f"{helpers.BASE_URL}/entity/prepayment/{self.id}"
        )
...
class UpdatePrepaymentRequest(types.ApiRequest):
    UpdatePosition = CreatePrepaymentRequest.CreatePosition
...
class GetPrepaymentPositionsRequest(types.ApiRequest):
    def __init__(
        self,
        prepayment_id: str,
        limit: typing.Union[Unset, int] = Unset,
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/prepayment/{self.prepayment_id}/positions",
            params=params,
        )
...
class GetPrepaymentPositionRequest(types.ApiRequest):
    def __init__(self, prepayment_id: str, position_id: str):
        self.prepayment_id = prepayment_id
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/prepayment/{self.prepayment_id}/positions/{self.position_id}",
        )
