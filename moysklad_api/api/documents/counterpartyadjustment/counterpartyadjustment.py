...
class CounterpartyAdjustment(types.MoySkladBaseClass):
    """Корректировка взаиморасчетов (entity/counterpartyadjustment). Без позиций."""
    ...
    @classmethod
    def from_json(cls, dict_data: dict) -> "CounterpartyAdjustment":
        instance = cls()
...
class GetCounterpartyAdjustmentsRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/counterpartyadjustment",
            params=params,
        )

    def from_response(self, result: dict) -> typing.List[CounterpartyAdjustment]:
        return [CounterpartyAdjustment.from_json(x) for x in result["rows"]]


class CreateCounterpartyAdjustmentRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def from_response(self, result: dict) -> CounterpartyAdjustment:
        return CounterpartyAdjustment.from_json(result)


class DeleteCounterpartyAdjustmentRequest(types.ApiRequest):
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="DELETE",
            url=f"{helpers.BASE_URL}/entity/counterpartyadjustment/{self.id}",
            allow_non_json=True,
        )
...
class GetCounterpartyAdjustmentRequest(types.ApiRequest):
    def __init__(self, id_: str):
        self.id = id_
...
class UpdateCounterpartyAdjustmentRequest(types.ApiRequest):
    def __init__(
        self,
        id_: str,
        organization: typing.Union[Unset, types.Meta] = Unset,
