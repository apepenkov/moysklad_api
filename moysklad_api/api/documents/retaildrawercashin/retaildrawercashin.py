...
class RetailDrawerCashIn(types.MoySkladBaseClass):
    """Внесение денег (entity/retaildrawercashin). Плоский документ без позиций."""
    ...
    @classmethod
    def from_json(cls, dict_data: dict) -> "RetailDrawerCashIn":
        instance = cls()
...
class GetRetailDrawerCashInsRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/retaildrawercashin",
            params=params,
        )

    def from_response(self, result: dict) -> typing.List[RetailDrawerCashIn]:
        return [RetailDrawerCashIn.from_json(x) for x in result["rows"]]


class CreateRetailDrawerCashInRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def from_response(self, result: dict) -> RetailDrawerCashIn:
        return RetailDrawerCashIn.from_json(result)


class DeleteRetailDrawerCashInRequest(types.ApiRequest):
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="DELETE",
            url=f"{helpers.BASE_URL}/entity/retaildrawercashin/{self.id}",
            allow_non_json=True,
        )
...
class GetRetailDrawerCashInRequest(types.ApiRequest):
    def __init__(self, id_: str):
        self.id = id_
...
class UpdateRetailDrawerCashInRequest(types.ApiRequest):
    def __init__(
        self,
        id_: str,
        organization: typing.Union[Unset, types.Meta] = Unset,
