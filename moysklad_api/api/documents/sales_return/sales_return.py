...
class SalesReturn(types.MoySkladBaseClass):
    """Возврат покупателя (entity/salesreturn)."""
    ...
    demand: typing.Optional[types.Meta]
    losses: typing.Optional[typing.List[types.Meta]]
    payments: typing.Optional[typing.List[types.Meta]]
    payed_sum: typing.Optional[float]
    facture_out: typing.Optional[types.Meta]

    @classmethod
    def from_json(cls, dict_data: dict) -> "SalesReturn":
        instance = cls()
        ...
        instance.demand = helpers.get_meta(dict_data.get("demand"))
        instance.losses = [
            helpers.get_meta(x, must=True) for x in dict_data.get("losses", [])
        ]
        instance.payments = [
...
def _build_json(
    ...
    demand: typing.Union[Unset, types.Meta] = Unset,
...
class GetSalesReturnsRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET", url=f"{helpers.BASE_URL}/entity/salesreturn", params=params
        )

    def from_response(self, result: dict) -> typing.List[SalesReturn]:
        return [SalesReturn.from_json(x) for x in result["rows"]]


class CreateSalesReturnRequest(types.ApiRequest):
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="POST", url=f"{helpers.BASE_URL}/entity/salesreturn", json=json_data
        )

    def from_response(self, result: dict) -> SalesReturn:
        return SalesReturn.from_json(result)


class DeleteSalesReturnRequest(types.ApiRequest):
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="DELETE",
            url=f"{helpers.BASE_URL}/entity/salesreturn/{self.id}",
            allow_non_json=True,
        )
...
class GetSalesReturnRequest(types.ApiRequest):
    def __init__(self, id_: str):
        self.id = id_

    def to_request(self) -> RequestData:
        return RequestData(
            method="GET", url=f"{helpers.BASE_URL}/entity/salesreturn/{self.id}"
        )
...
class UpdateSalesReturnRequest(types.ApiRequest):
    UpdatePosition = CreateSalesReturnRequest.CreatePosition
...
class GetSalesReturnPositionsRequest(types.ApiRequest):
    def __init__(
        self,
        salesreturn_id: str,
        limit: typing.Union[Unset, int] = Unset,
        ...
        self.salesreturn_id = salesreturn_id
        self.limit = limit
        self.offset = offset
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/salesreturn/{self.salesreturn_id}/positions",
            params=params,
        )
...
class CreateSalesReturnPositionRequest(types.ApiRequest):
    def __init__(
        self,
        salesreturn_id: str,
        assortment: types.Meta,
...
class GetSalesReturnPositionRequest(types.ApiRequest):
    def __init__(self, salesreturn_id: str, position_id: str):
        self.salesreturn_id = salesreturn_id
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/salesreturn/{self.salesreturn_id}/positions/{self.position_id}",
        )
...
class UpdateSalesReturnPositionRequest(types.ApiRequest):
    def __init__(
        self,
        salesreturn_id: str,
        position_id: str,
...
class DeleteSalesReturnPositionRequest(types.ApiRequest):
    def __init__(self, salesreturn_id: str, position_id: str):
        self.salesreturn_id = salesreturn_id
        self.position_id = position_id
