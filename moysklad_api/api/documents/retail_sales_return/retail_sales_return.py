...
class RetailSalesReturn(types.MoySkladBaseClass):
    """Розничный возврат (entity/retailsalesreturn)."""
    ...
    @classmethod
    def from_json(cls, dict_data: dict) -> "RetailSalesReturn":
        instance = cls()
...
class Position(types.MoySkladBaseClass):
    ...
    @staticmethod
    def ms_name() -> typing.Optional[typing.Tuple[str]]:
        return "retailsalesreturn", "positions"
...
class GetRetailSalesReturnsRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/retailsalesreturn",
            params=params,
        )

    def from_response(self, result: dict) -> typing.List[RetailSalesReturn]:
        return [RetailSalesReturn.from_json(x) for x in result["rows"]]


class CreateRetailSalesReturnRequest(types.ApiRequest):
    ...
    def from_response(self, result: dict) -> RetailSalesReturn:
        return RetailSalesReturn.from_json(result)


class DeleteRetailSalesReturnRequest(types.ApiRequest):
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="DELETE",
            url=f"{helpers.BASE_URL}/entity/retailsalesreturn/{self.id}",
            allow_non_json=True,
        )
...
class GetRetailSalesReturnRequest(types.ApiRequest):
    def __init__(self, id_: str):
        self.id = id_

    def to_request(self) -> RequestData:
        return RequestData(
            method="GET", url=f"{helpers.BASE_URL}/entity/retailsalesreturn/{self.id}"
        )
...
class UpdateRetailSalesReturnRequest(types.ApiRequest):
    UpdatePosition = CreateRetailSalesReturnRequest.CreatePosition
...
class GetRetailSalesReturnPositionsRequest(types.ApiRequest):
    def __init__(
        self,
        ...
        self.retailsalesreturn_id = retailsalesreturn_id
        self.limit = limit
        self.offset = offset
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/retailsalesreturn/{self.retailsalesreturn_id}/positions",
            params=params,
        )
...
class GetRetailSalesReturnPositionRequest(types.ApiRequest):
    def __init__(self, retailsalesreturn_id: str, position_id: str):
        self.retailsalesreturn_id = retailsalesreturn_id
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="GET",
            url=f"{helpers.BASE_URL}/entity/retailsalesreturn/{self.retailsalesreturn_id}/positions/{self.position_id}",
        )
