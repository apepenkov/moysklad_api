...
class CashOut(types.MoySkladBaseClass):
    """Расходный ордер (entity/cashout). Плоский документ без позиций."""
    ...
    @classmethod
    def from_json(cls, dict_data: dict) -> "CashOut":
        instance = cls()
...
class GetCashOutsRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="GET", url=f"{helpers.BASE_URL}/entity/cashout", params=params
        )

    def from_response(self, result: dict) -> typing.List[CashOut]:
        return [CashOut.from_json(x) for x in result["rows"]]


class CreateCashOutRequest(types.ApiRequest):
    def __init__(
        self,
    ...
    def to_request(self) -> RequestData:
        ...
        return RequestData(
            method="POST", url=f"{helpers.BASE_URL}/entity/cashout", json=json_data
        )

    def from_response(self, result: dict) -> CashOut:
        return CashOut.from_json(result)


class DeleteCashOutRequest(types.ApiRequest):
    ...
    def to_request(self) -> RequestData:
        return RequestData(
            method="DELETE",
            url=f"{helpers.BASE_URL}/entity/cashout/{self.id}",
            allow_non_json=True,
        )
...
class GetCashOutRequest(types.ApiRequest):
    def __init__(self, id_: str):
        self.id = id_

    def to_request(self) -> RequestData:
        return RequestData(
            method="GET", url=f"{helpers.BASE_URL}/entity/cashout/{self.id}"
        )
...
class UpdateCashOutRequest(types.ApiRequest):
    def __init__(
        self,
        id_: str,
        organization: typing.Union[Unset, types.Meta] = Unset,
